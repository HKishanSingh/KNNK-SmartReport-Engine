...
* XGBoost-based forecasting model optimized for campaign delivery data.
* Prophet forecasting for long-duration campaigns with seasonal patterns.
* Confidence scoring and historical accuracy measurement.
* Automated holdout testing using MAPE-based accuracy calculations.

**GAM vs DCM Reconciliation**
* Compare delivery metrics across platforms.
* Detect discrepancies automatically.
* Flag reporting mismatches for investigation.
...
KNNK SmartReport Engine reduces manual reporting effort, improves forecast reliability, increases reporting accuracy, and provides a centralized analytics solution for campaign managers, ad operations teams, and digital marketing professionals.
...
<img width="1913" height="863" alt="image" src="https://github.com/user-attachments/assets/ed136c9d-f0ff-4519-9d7a-465f0df3f372" />
<img width="1700" height="685" alt="image" src="https://github.com/user-attachments/assets/36b90a40-e2a0-435f-8073-01c78214fc14" />
<img width="1686" height="700" alt="image" src="https://github.com/user-attachments/assets/aaebd40b-02a7-4e96-aa12-60097f2f36d3" />
<img width="1909" height="810" alt="image" src="https://github.com/user-attachments/assets/29a1efa2-96f0-4c7f-a639-b89c6837d815" />
<img width="1888" height="808" alt="image" src="https://github.com/user-attachments/assets/57a89434-cd8f-4a7b-ad00-163f3b4ad599" />
<img width="1671" height="766" alt="image" src="https://github.com/user-attachments/assets/b5b4571b-68e7-4aee-b742-9057dad95b73" />
